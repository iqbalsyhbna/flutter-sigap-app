        ...
        Wrap(children: [
          Container(
            ...
            decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                      color: (context.isDarkMode) ? primaryColor : Colors.black,
          ...
          Container(
            ...
            child: Column(
              children: [
                Text(
                  title,
                  style: baseFontStyleVeryBig.copyWith(
  ...
  Widget build(BuildContext context) {
    return Dialog(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: (context.isDarkMode) ? Colors.white : systemBlackColor,
            shape: BoxShape.rectangle,
            borderRadius: BorderRadius.circular(17),
            boxShadow: [
              BoxShadow(
                  color: (context.isDarkMode) ? Colors.white : Colors.black26,
        ...
        child: Column(
          ...
          children: [
            ...
            const SpinKitThreeBounce(size: 35, color: primaryColor),
          ],
        ),
      ),
    );
